...
const Product = () => {
  ...
  //       let url;
  //       if (searchQuery) {
  //         url = `https://midknighttestdomain.site/api/v1/search(
  //           searchQuery
  //         )}`;
  //         console.log('here')
  ...
  //         console.log('here')
  //       } else if(!searchQuery && !selectedCategory && !selectedChildCategory && !selectedSubChildCategory) {
  //       url = `https://midknighttestdomain.site/api/v1/get-main-products?page=${currentPage}`;
  //       console.log('here')
